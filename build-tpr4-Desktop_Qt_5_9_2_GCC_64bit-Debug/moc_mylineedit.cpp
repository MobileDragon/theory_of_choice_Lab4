...
QT_MOC_LITERAL(3, 21, 11), // "MyLineEdit*"
QT_MOC_LITERAL(4, 33, 9), // "myChanged"
QT_MOC_LITERAL(5, 43, 1) // "s"

    },
    "MyLineEdit\0MySignal\0\0MyLineEdit*\0"
    "myChanged\0s"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MySignal((*reinterpret_cast< MyLineEdit*(*)>(_a[1]))); break;
        case 1: _t->myChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLineEdit::MySignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_MyLineEdit.data,
      qt_meta_data_MyLineEdit,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void MyLineEdit::MySignal(MyLineEdit * _t1)
{
